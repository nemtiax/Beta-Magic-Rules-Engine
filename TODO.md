...
# Basics
- [x] Basic game state, cards, library, graveyard, battlefield, hands
- [x] Lands, mana, tapping, mana pool
- [x] Dual lands and selectable activated mana abilities
...
# Enchantments
- [x] Simple global enchantments (Orcish Oriflamme, Crusade, Bad Moon)
- [x] Simple enchant creatures (Holy Strength, Unholy Strength, Weakness)
- [x] Ability enchant creatures (Lance, Flight, Burrowing)
- [ ] Castle
- [ ] Animate Wall
- [x] Creature pump abilities (Shivan Dragon, Frozen Shade, Granite Gargoyle,
  Dragon Whelp)
...
- [x] Moxen, Sol Ring, Black Lotus

- [x] Copper Tablet and mandatory timed-event response windows
- [x] Timed damage Auras (Cursed Land, Feedback, Wanderlust, Warp Artifact)
- [x] Optional mana upkeep and UI prompt (Phantasmal Forces, Force of Nature)
- [ ] Ankh of Mishra, Dingus Egg
